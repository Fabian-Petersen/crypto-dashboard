    ...
    <>
      <ul className="capitalize text-clr_blueGray_700 flex flex-col gap-2 h-full w-full mx-auto px-2">
        {pageLinkData.map((link) => (
          <li
            key={link.id}
            className="tracking-wider flex items-center gap-2 justify-start hover:cursor-pointer lg:hover:bg-clr_primary_900 bg-transparent py-4 mx-auto lg:mx-0 px-4 hover:bg-gray-400 hover:rounded-lg text-gray-800"
          >
